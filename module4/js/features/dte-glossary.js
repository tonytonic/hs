...
const STUDIES = [
  ...
  {
    id:'KUNN_NELEN_2016', cat:'Trajet domicile-travail', couleur:'#9b6dff', nouveaute:true,
    titre:'Le temps de trajet domicile-travail et le bien-être des salariés',
    auteurs:'Künn-Nelen A.',
    journal:'Journal of Health Economics', annee:2016,
    lien:'https://doi.org/10.1016/j.jhealeco.2016.07.005',
    population:'Salariés — données de panel longitudinales',
    seuil:'>60 min A/R = seuil critique sur la santé déclarée',
    preuve:'★★★ Étude économétrique de panel — référence sur le trajet',
    resultats:[
      'Temps de trajet long → baisse significative du bien-être et de la santé déclarée',
      'Effet dose-réponse : facteur durée 0.05 (<30 min) → 0.28 (>90 min)',
      'Le trajet pèse sur le stress indépendamment de la durée de travail',
      'Le lien avec le risque cardiovasculaire reste indirect (non mesuré directement)',
    ],
    dte:'Feature Trajet · commuteLoad28 → stress ×0.45 · facteur durée',
    tags:['trajet','commute','domicile-travail','stress','durée','bien-être','Künn-Nelen'],
  },
  {
    id:'EVANS_2002', cat:'Trajet domicile-travail', couleur:'#9b6dff', nouveaute:true,
    titre:'L\'imprévisibilité du trajet domicile-travail et le stress physiologique',
    auteurs:'Evans G.W., Wener R.E., Phillips D.',
    journal:'Environment & Behavior', annee:2002,
    lien:'https://doi.org/10.1177/0013916502034004007',
    population:'Navetteurs ferroviaires — mesures de cortisol salivaire',
    seuil:'Imprévisibilité / retards = facteur de stress majeur',
    preuve:'★★★ Étude expérimentale avec biomarqueurs (cortisol)',
    resultats:[
      'Trajet imprévisible (retards) → cortisol +18% vs trajet fluide',
      'L\'imprévisibilité compte plus que la durée brute du trajet',
      'Facteur qualité : 0.80 (fluide) → 1.53 (difficile/stressant)',
      'Effet indépendant du mode de transport — c\'est le ressenti qui prime',
    ],
    dte:'Feature Trajet · qualityFactor 1.30–1.53 · qualité déclarée (Q3)',
    tags:['trajet','commute','cortisol','imprévisibilité','retard','stress','Evans'],
  },
  {
    id:'NOVACO_2004', cat:'Trajet domicile-travail', couleur:'#9b6dff', nouveaute:true,
    titre:'Congestion routière, stress du trajet et récupération',
    auteurs:'Novaco R.W., Gonzalez O.I.',
    journal:'Journal of Applied Psychology', annee:2004,
    lien:'https://psycnet.apa.org/record/2004-10043-001',
    population:'Automobilistes pendulaires — mesures de récupération',
    seuil:'Congestion élevée = récupération réduite',
    preuve:'★★ Étude de terrain sur la congestion et la fatigue',
    resultats:[
      'Congestion routière → récupération réduite d\'environ 15%',
      'Le trajet difficile empiète sur le temps de détachement psychologique',
      'Effet cumulatif : un trajet difficile répété maintient une charge de fond',
    ],
    dte:'Feature Trajet · commuteLoad28 → récupération −0.25',
    tags:['trajet','commute','congestion','récupération','détachement','Novaco'],
  },
  {
    id:'ANACT_2015_TRAJET', cat:'Trajet domicile-travail', couleur:'#9b6dff', nouveaute:true,
    titre:'Amplitude de la journée de travail et fatigue (trajet inclus)',
    auteurs:'Agence Nationale pour l\'Amélioration des Conditions de Travail (ANACT) — France',
    journal:'Publications ANACT', annee:2015,
    lien:'https://www.anact.fr/',
    population:'Référentiel national — conditions de travail',
    seuil:'Amplitude journée (travail + trajet) = facteur de fatigue',
    preuve:'★★ Référentiel autorité nationale française',
    resultats:[
      'L\'amplitude totale de la journée (trajet compris) aggrave la fatigue',
      'Le trajet allonge la journée effective et réduit le temps de récupération',
      'Facteur indépendant de la seule durée de travail',
    ],
    dte:'Feature Trajet · commuteLoad28 → fatigue ×0.30',
    tags:['trajet','commute','amplitude','fatigue','ANACT','France'],
  },
  {
    id:'HANSSON_2011', cat:'Trajet domicile-travail', couleur:'#9b6dff', nouveaute:true,
    titre:'Mode de transport domicile-travail et santé perçue',
    auteurs:'Hansson E., Mattisson K., Björk J. et al.',
    journal:'Journal of Transport & Health (BMC Public Health)', annee:2011,
    lien:'https://doi.org/10.1186/1471-2458-11-834',
    population:'21 088 personnes · Scanie (Suède)',
    seuil:'Comparaison modes actifs vs passifs',
    preuve:'★ Étude transversale — tendance (statistique uniquement)',
    resultats:[
      'Associations entre mode de transport et santé perçue (tendance)',
      'Dans SimulHeures : le mode est STOCKÉ pour statistiques uniquement',
      'C\'est la qualité déclarée (Q3), pas le mode (Q1), qui pilote le calcul biologique',
    ],
    dte:'Feature Trajet · commuteMode (statistique, n\'affecte pas les scores)',
    tags:['trajet','commute','mode','transport','vélo','voiture','Hansson','statistique'],
  },
];
...
const CONCEPTS = [
  ...
  { terme:'Contingent annuel d\'HS', lien:'CODE_TRAVAIL_FR', tags:['contingent','HS','RCO','légal'],
    def:(()=>{const _c=typeof CCN_API!=='undefined'?CCN_API.getGroupeForCCN(parseInt(localStorage.getItem('CCN_IDCC')||'0')).contingent:220;return 'Volume d\'heures supplémentaires effectuables sans autorisation de l\'inspection du travail : '+_c+'h/an légal (Art. L3121-33). Au-delà : Repos Compensateur Obligatoire (RCO) de 100% = 1h de repos par heure au-delà.';})() },
  ...
  { terme:'Repos Compensateur Obligatoire (RCO)', lien:'CODE_TRAVAIL_FR', tags:['RCO','contingent','légal','repos'],
    def:(()=>{const _c=typeof CCN_API!=='undefined'?CCN_API.getGroupeForCCN(parseInt(localStorage.getItem('CCN_IDCC')||'0')).contingent:220;return 'Droit automatique à 1 heure de repos pour toute heure travaillée au-delà du contingent annuel de '+_c+'h (Art. L3121-38). L\'employeur ne peut pas refuser. Délai de prise : 2 mois après ouverture du droit (Art. D3121-18).';})() },

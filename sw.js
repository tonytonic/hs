 ...
 * Version : 10.9.17 — Cloudflare Pages (Google Play compliance : disclaimers non-gouv + sources)
 */

const CACHE_NAME = "heuressup-cache-v10.9.17"; // partage : deux liens (iOS + Android)
